...
The code will take a **.npy** file as input containing an array of shape $$(NxJx3)$$. where N is the number of frames in the sequence, J the number of joints in the 3D Keypoint data. For example, if there is a (500x24x3) array given as input, there are 24 x 3D Joints and 500 frames of input.  
